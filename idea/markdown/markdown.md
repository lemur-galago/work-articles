...
Настроить форматирование файлов можно в **File | Settings | Editor | Code Style | Markdown**

## Советы по эффективному использованию

### Комментарии в markdown-файле

Markdown не имеет специального синтаксиса для написания комментариев, однако обычно принято использовать с целью 
сомментирования текста ссылку без адреса следующего формата:

```
[comment]: <> (Your comment text)
```

Перед ссылкой такого формата должна быть пустая строка

Вместо `comment` в IntelliJ IDEA принято использовать `//`. Быстрый комментарий можно добавить с помощью сочетания 
клавиш <kbd>Ctrl</kbd><kbd>/</kbd>

#### TODO в комментариях

В комментарий можно добавлять _TODO-_, тогда такой комментарий по умолчанию будет подсвечиваться в редакторе в 
соответствии с настройками IDE.

[//]: # (TODO - Это просто тескстовый комментарий)

![](img/comment-todo.png)

[//]: # (TODO - А это еще один тексовый комментарий)

Комментарий, оформленный таким образом, отображается на панели _TODO_, отображение которой можно включить в меню 
**View | Tool windows | TODO**

### Навигация в больших файлах

Для удобства навигации в больших файлах можно включить панель структуры в меню **View | Tool windows | Structure** 
(<kbd>Alt</kbd><kbd>7</kbd>) или вызвать окно структуры файла <kbd>Ctrl</kbd><kbd>F12</kbd>

### Настройка подсветки синтаксиса markdown-файла

В IntelliJ IDEA можно настроить цветовую схему подсветки синтаксиса в меню **File | Settings | Editor | Code Style | Markdown**

### CSS - стили для предпросмотра

IntelliJ IDEA поддерживает кастомные стили для просмотра md-файла. Стиль можно задать в меню **File | Settings | Languages & Frameworks | Markdown**
